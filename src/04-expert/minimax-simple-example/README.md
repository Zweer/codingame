...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/expert/minimax-simple-example)
...
**Line 1 :** C the best choice for the first turn, a space, and S1\-S2 the expected final scores for the player 1 and 2.
