...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/expert/running-up-that-hill)

**Level:** expert
**Topics:** Cryptography, Mathematics, Modular calculus, Arithmetic, Linear algebra
