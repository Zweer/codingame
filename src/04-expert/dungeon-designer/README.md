...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/expert/dungeon-designer)
...
**Note 2:** For the reproducibility of the map across languages, you are given two primes P and Q, and a seed R, and you will generate pseudo-random numbers using the Blum Blum Shub algorithm (its name goes well with the theme… more information here: https://en.wikipedia.org/wiki/Blum\_Blum\_Shub )  
