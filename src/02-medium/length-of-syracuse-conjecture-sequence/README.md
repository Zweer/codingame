...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/length-of-syracuse-conjecture-sequence)

**Level:** medium
**Topics:** Memoization, Sequences
...
For any two numbers A and B you are to determine the maximum cycle-length over all numbers between them, including A and B. 

Input

**Line 1:** An Integer N the number of ranges to compute.  
**Next N lines:** Two integers A and B respectively the lower and upper bound of the range.

Output

**N lines:** i cycle\_length the lowest integer that leads to the longest cycle-length, and the cycle length itself, separated by a space.
