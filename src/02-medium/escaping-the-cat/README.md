...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/escaping-the-cat)
...
The mouse has a maximum speed MOUSE\_SPEED of **10 Pixels / turn** so then when providing a target destination the mouse will move towards this destination but the distance will be capped to MOUSE\_SPEED.  
