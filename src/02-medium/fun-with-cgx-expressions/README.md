...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/fun-with-cgx-expressions)

**Level:** medium
**Topics:** Parsing, Recursion, Strings
...
The CGX file contains a BLOCK with 2 KEY\_VALUE fields: result and optionally vars.  
...
Each **variable** (a KEY\_VALUE) has a value that is an expression.  
An **expression** could be:   
\- a constant value PRIMITIVE\_TYPE int, 

e.g. ('v1'=10)

  
\- if the expression is a PRIMITIVE\_TYPE str, then it is a variable name, 

e.g. ('v1'='v2')

  
\- a BLOCK with 3 KEY\_VALUE num1 , num2 and an operator: + \- / \*, 
...
The result of the expression in the KEY\_VALUE 'result'.
...
A KEY\_VALUE 'result' will always be present.  
