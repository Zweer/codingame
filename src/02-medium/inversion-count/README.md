...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/inversion-count)
...
For all the tests and validators :  
 ...
 \- The array values are generated with a simple LCG (https://en.wikipedia.org/wiki/Linear\_congruential\_generator).  
