...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/reversed-look-and-say)

**Level:** medium
**Topics:** Loops, String manipulation
...
You can find detailed information of this sequence in https://en.wikipedia.org/wiki/Look-and-say\_sequence. 
...
Log(n) < 100  
No digit appears consecutively more than 9 times for any element in the series.
