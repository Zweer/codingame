...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/rod-cutting-problem)
...
The rod cutting problem is the one-dimensional variant of the cutting stock problem. https://en.wikipedia.org/wiki/Cutting\_stock\_problem 
