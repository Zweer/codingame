...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/2-player-game-on-a-calculator)
...
**Line 1 :** 0 to 9 integers, separated with spaces, from lowest to highest. These are the winning moves when playing first and N is the starting number
