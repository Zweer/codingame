# Decimal numbers to floating numbers

[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/decimal-numbers-to-floating-numbers)

**Level:** medium
**Topics:** Parsing, String manipulation, Numbers
...
**External reference**  
https://en.wikipedia.org/wiki/Single-precision\_floating-point\_format 
