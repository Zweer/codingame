# Detective Pikaptcha EP3

[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/detective-pikaptcha-ep3)

**Level:** medium
**Topics:** Simulation, Maze, Moebius, Mobius
...
The Möbius strip maze is given to you as a grid filled with 0s and #s, where 0represents a passage, and # represents a wall: an impassable cell. 
...
![from-data-to-a-mobius](https://forum.codingame.com/uploads/default/original/3X/6/d/6d5bd0e947f0af7c21287b1a05ba63ed940f9b6d.jpeg)  
...
Next height lines: a string line of length widthwhere 0 is a passage and # is a wall and \>, v, < or ^ is the initial position of Pikaptcha. 
