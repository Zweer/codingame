...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/byte-pair-encoding)

**Level:** medium
**Topics:** Encoding, Compression, Byte-pair
...
We will use the **recursive** version of the algorithm, in which replaced pairs can include non-terminal characters. (Note: this algorithm generates a context-free grammar: https://en.wikipedia.org/wiki/Context-free\_grammar)  
  
For a more detailed explanation, see https://en.wikipedia.org/wiki/Byte\_pair\_encoding  
...
Next N lines: the INPUT\_STRING split into chunks of width M

Output

First line: the encoded OUTPUT\_STRING  
...
2 <= N \* M \= length of INPUT\_STRING <=1000
