...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/russian-dolls)

**Level:** medium
**Topics:** Recursion, Data Validation
...
To standardize the representation, the negative number of a doll size should always be placed before the positive number. All the parts must be arranged according to their nesting order.  
