...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/agent-x-mission-2mysterious-cryptogram)
...
**Next 26 Lines** char\_substitution : The substitution for each character in upper case, in the format of original\_letter \-> substitute\_letter (e.g. A -> E), or Na if there is no information on the substitution of the character.
