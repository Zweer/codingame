...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/frequency-based-decryption)

**Level:** medium
**Topics:** Encoding, Strings, Cryptography, String manipulation

## Goal 

Information on the shift cipher : https://en.wikipedia.org/wiki/Caesar\_cipher  
