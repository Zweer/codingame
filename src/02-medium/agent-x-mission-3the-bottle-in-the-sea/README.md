# Agent X, Mission 3—The Bottle In The Sea

[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/agent-x-mission-3the-bottle-in-the-sea)

**Level:** medium
**Topics:** Cryptography, Cipher
...
You'll have to decrypt the message left by Agent X. To do so you are given the key\_length of the key and a word in the message.  
...
**Line 2** key\_length : The size of the key  
...
**Line 2** plaintext : The decrypted message or the first 900 characters if there are more than 900
