...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/particle-detection-with-cloud-chamber)

**Level:** medium
**Topics:** Strings, Ascii Art, Physics, Least-squares, Gradient descent
...
Likewise, the ratio **g = abs(q)/m** could not be computed exactly. Let’s note **g\_p** the theoritical value of particle **p** (given in the table above) and **G** the computed value from ASCII-art picture with the formula above.  
...
**Line 1:** An integer w width of the picture.  
