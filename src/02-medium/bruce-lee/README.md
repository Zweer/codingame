...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/bruce-lee)
...
**1**000001 -> 0 0 (bit 1, one time)  
1**00000**1 -> 00 00000 (bit 0, five times)  
100000**1** \-> 0 0 (bit 1, one time)  
