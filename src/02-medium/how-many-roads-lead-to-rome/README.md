...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/how-many-roads-lead-to-rome)

**Level:** medium
**Topics:** Graphs, Pathfinding
...
**Next N lines**: Two space-separated integers A and B corresponding to the two cities the path connects
