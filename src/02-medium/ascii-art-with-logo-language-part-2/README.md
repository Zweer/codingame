...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/ascii-art-with-logo-language-part-2)

**Level:** medium
**Topics:** Ascii Art, Interpreters
...
REPEAT can be nested. For example: 
