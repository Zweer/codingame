...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/ascii-cube)
...
• Because a console character is higher than large, a unit of 1 w (width) is represented with two characters instead of one (\_\_ or ..).  
