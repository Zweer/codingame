# Can you save the forest - Episode 1

[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/can-you-save-the-forest---episode-1)

**Level:** medium
**Topics:** Monte Carlo tree search, Simulation, 2D array, Beam Search
...
1. Extinguish the fire on the square determined by your program.
2. Evolution of the remaining fires (1>>2, 2>>3, 3>>burned)
3. Spread of fire around the squares that have just been burned
