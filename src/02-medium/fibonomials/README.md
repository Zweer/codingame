...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/fibonomials)

**Level:** medium
**Topics:** Parsing, Recursion, String manipulation, Polynomials
...
The string entry defined\_by takes one of the values COEFS, ROOTS to specify whether the polynomials are defined by their coefficients (increasing powers) or by their roots.  
...
**Line 1:** The string defined\_by COEFS or ROOTS  
