...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/were-going-in-circles)
...
The goal is to count the number\_of\_loops in the grid. 
...
The number\_of\_loops in the grid.
