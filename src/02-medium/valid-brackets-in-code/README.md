# Valid brackets in code

[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/valid-brackets-in-code)

**Level:** medium
**Topics:** Loops, Regular expressions, String manipulation, Stack, parenthesis
