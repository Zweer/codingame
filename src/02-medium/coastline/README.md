...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/coastline)

**Level:** medium
**Topics:** Greedy algorithms, Geometry
...
**Problem**  
Given the locations of all islets together with the effective radius of transmitters, find the minimum number of transmitters needed to be installed, if we want all islets be covered within range. 
