...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/source-code-analyser)

**Level:** medium
**Topics:** Parsing, String manipulation
...
\* Useless fun fact: my toplist in 98k source lines of PHP: fscanf, error\_log, strlen, isset, ord  
