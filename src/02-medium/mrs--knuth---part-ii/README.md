...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/mrs--knuth---part-ii)
...
This puzzle is part 2 of a multi-part Algorithm X tutorial and is meant to be done per the guidance in the following playground:  
