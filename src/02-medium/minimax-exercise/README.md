...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/minimax-exercise)
...
To make our algorithm more efficient, we can skip some computations using the alpha-beta prunning technique ( https://en.wikipedia.org/wiki/Alpha-beta\_pruning ).  
