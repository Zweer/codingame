...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/boggle-with-friends)

**Level:** medium
**Topics:** Lists, 2D array
...
‣ A word doesn't count if more than one person writes it.  
...
‣ Credit to: https://www.litscape.com/word\_tools/words\_made\_from.php -- that website helped create this 
