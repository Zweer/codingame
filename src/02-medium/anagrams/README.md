...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/anagrams)

**Level:** medium
**Topics:** Cryptography, String manipulation
...
Consecutive words are delimited by a single space, and there are no leading or trailing spaces.
