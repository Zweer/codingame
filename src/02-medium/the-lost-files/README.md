...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/the-lost-files)

**Level:** medium
**Topics:** Geometry, Graph theory, Topology, graph traversal, Connected components
