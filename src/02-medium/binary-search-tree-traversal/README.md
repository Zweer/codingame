...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/medium/binary-search-tree-traversal)

**Level:** medium
**Topics:** graph traversal, Binary Tree
...
Need more context? https://en.wikipedia.org/wiki/Tree\_traversal 
