...
[:link: Puzzle on CodinGame](https://www.codingame.com/multiplayer/optimization/samegame)

**Level:** optim
**Topics:** Flood fill, Simulation, Beam Search, Tile-matching, NRPA

This is a port of the tile-matching puzzle [SameGame](https://en.wikipedia.org/wiki/SameGame). The rules are the same as used for benchmarks in AI publications. Human-playable version is available [here](http://www.js-games.de/eng/games/samegame/lx/play). 
