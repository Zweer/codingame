...
[:link: Puzzle on CodinGame](https://www.codingame.com/multiplayer/optimization/travelling-salesman)

**Level:** optim
**Topics:** Greedy algorithms, Simulated Annealing, Heuristic search
...
# The Travelling Salesman Problem 
 ...
 There is a [puzzle](https://www.codingame.com/training/easy/the-travelling-salesman-problem) about the TSP on this website already, which features one heuristic algorithm called "Nearest neighbor". 
