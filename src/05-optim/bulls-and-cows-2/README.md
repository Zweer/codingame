...
[:link: Puzzle on CodinGame](https://www.codingame.com/multiplayer/optimization/bulls-and-cows-2)
...
This is an adaptation of a classic game of Bulls and Cows, where you will have to guess the number on the base of hints given each turn. One can also start by solving a [slightly more simple version](https://www.codingame.com/ide/puzzle/bulls-and-cows) of the game. 
