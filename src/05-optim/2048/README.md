...
[:link: Puzzle on CodinGame](https://www.codingame.com/multiplayer/optimization/2048)

**Level:** optim
**Topics:** Simulation, Beam Search
...
For technical limitations you can only output 600 commands per game. To allow for longer games, you can print multiple actions at once. The game uses a pseudo-random number generator to spawn new numbers, please refer to [github](https://github.com/eulerscheZahl/2048/blob/master/src/main/java/engine/Board.java#L25) for details.  
