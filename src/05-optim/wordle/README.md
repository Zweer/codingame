...
[:link: Puzzle on CodinGame](https://www.codingame.com/multiplayer/optimization/wordle)

**Level:** optim
**Topics:** Brute-force, Combinatorics

# The Goal 

This is an adaptation of an online game Wordle [(https://www.nytimes.com/games/wordle/index.html)](https://www.nytimes.com/games/wordle/index.html) with slight modifications in the rules.   
  
The goal of the game is to guess the hidden word based on the hints given each turn. 

# Rules 

1. At each turn, the player will guess a word.
2. After each guess, the player will know the state of each letter.  
...
3. A letter can appear multiple times in the word.  
...
4. Leaderboard is ascended by the amount of total guesses among all the validation test cases.
