...
[:link: Puzzle on CodinGame](https://www.codingame.com/multiplayer/optimization/search-race)

**Level:** optim
**Topics:** Simulation, Genetic Algorithm, Simulated Annealing, Beam Search
...
If you're going to run local simulations, you'll need to look at the [referee.](https://github.com/Illedan/CGSearchRace) 
