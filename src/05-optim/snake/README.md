...
[:link: Puzzle on CodinGame](https://www.codingame.com/multiplayer/optimization/snake)

**Level:** optim
**Topics:** Pathfinding, Distances, Graph theory, Travelling salesman
...
\- You have a penalty if you don't catch a rabbit in 10 turns. The penalty is turn \* NB\_TURN\_WITHOUT\_CATCH\_RABBIT.  
\- Then the score is calculated, SCORE += 10000 + add\_combo - penalty. add\_combo is equal to NB\_CATCH\_IN\_2\_TURNS\_MIN \* 15000\. After 2 turns NB\_CATCH\_IN\_2\_TURNS\_MIN is reset. 
