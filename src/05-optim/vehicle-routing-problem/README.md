...
[:link: Puzzle on CodinGame](https://www.codingame.com/multiplayer/optimization/vehicle-routing-problem)

**Level:** optim
**Topics:** Greedy algorithms, Genetic Algorithm, Simulated Annealing, Metaheuristics

## Capacitated Vehicle Routing

In the [Vehicle Routing Problem](https://en.wikipedia.org/wiki/Vehicle%5Frouting%5Fproblem), you must serve a set of customers with a fleet of vehicles.   
In the _Capacitated_ variant, vehicles have a limited capacity.   
...
* Have you already solved [the Travelling Salesman Problem](https://www.codingame.com/multiplayer/optimization/travelling-salesman)? If so, maybe you can reuse your code: every vehicle tour is basically a small TSP.

# About the Test & Validation Instances 

* The 4 benchmark instances are from the [CVRPLib](http://vrp.atd-lab.inf.puc-rio.br/index.php/en/), specifically sets A and M. Their known optima is used to give you the optimality gap. Feel free to use other instances from the library to tune your algorithms.
