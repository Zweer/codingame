...
[:link: Puzzle on CodinGame](https://www.codingame.com/multiplayer/optimization/code-vs-zombies)

**Level:** optim
**Topics:** Optimization, Simulation, Distances
...
* If several zombies are destroyed during on the same round, the nth zombie killed's worth is multiplied by the (n+2)th number of the [Fibonnacci sequence](https://wikipedia.org/wiki/Fibonacci%5Fnumber) (1, 2, 3, 5, 8, and so on). As a consequence, you should kill the maximum amount of zombies during a same turn.
