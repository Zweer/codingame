# The Fall - Episode 3 - Code Golf

[:link: Puzzle on CodinGame](https://www.codingame.com/codegolf/expert/the-fall-episode-3-codesize)

**Level:** codegolf-expert
**Topics:** Backtracking, Pathfinding
...
![](https://files.codingame.com/codingame/indiana/question/rotation.png)  
_Spin the room (0,1) towards the right to establish a safe route to the exit._
...
![](https://files.codingame.com/codingame/indiana/question/example2_0.png)

No output expected

Output for turn 1

1 0 TOP_(XI YI POS)_
1      _(R)_
0 2 TOP_(XR YR POSR)_

Indy arrives in (1,0) from above. A rock appears in (0,2) from above.  
  
![](https://files.codingame.com/codingame/indiana/question/example2_1.png)
...
1 1 TOP  _(XI YI POS)_
1        _(R)_
1 2 LEFT _(XR YR POSR)_

Indy is now in (1,1). The rock is in (1,2)  
  
![](https://files.codingame.com/codingame/indiana/question/example2_2.png)
...
![](https://files.codingame.com/codingame/indiana/question/example2_3.png)
