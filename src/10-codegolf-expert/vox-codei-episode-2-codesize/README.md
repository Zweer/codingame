# Vox Codei - Episode 2 - Code Golf

[:link: Puzzle on CodinGame](https://www.codingame.com/codegolf/expert/vox-codei-episode-2-codesize)

**Level:** codegolf-expert
**Topics:** DFS, Brute-force, Pattern recognition, Simulation

## The Goal

You access the central computer's firewall interface via Viktor's tablet. The firewall is comprised of surveillance nodes.  
  
This puzzle is the second level of _Vox Codei_: your objective is still to destroy these nodes by overloading them with the help of fork-bombs, but this time **the nodes are moving**!  
...
![](https://files.codingame.com/codingame/vox-codei/images/boum-1g.png) 

1rst round

The fork-bomb has been placed

![](https://files.codingame.com/codingame/vox-codei/images/boum-2g.png) 

2nd round

The fork-bomb is charging

![](https://files.codingame.com/codingame/vox-codei/images/boum-3g.png) 
