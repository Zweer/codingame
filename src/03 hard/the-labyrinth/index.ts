...
class Game {
    ...
    initialize() {
        ...
        this.rows = parseInt(inputRows, 10); // number of rows.
        this.columns = parseInt(inputColumns, 10); // number of columns.
        this.alarm = parseInt(inputAlarm, 10); // number of rounds between the time the alarm countdown is activated and the time the alarm goes off.
    ...
    initializePlayer() {
        ...
        const y: number = parseInt(rInput, 10); // row where Rick is located.
        const x: number = parseInt(cInput, 10); // column where Rick is located.
