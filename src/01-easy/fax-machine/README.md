...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/fax-machine)
...
This encoding system is similar Modified Huffman Coding, which the earliest digital fax machines used. See https://en.wikipedia.org/wiki/Modified\_Huffman\_coding 
