...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/the-broken-editor)
...
All typed\_keys can be either a **character**, a **keyboard arrow** (left / right) represented by < and \> or a **backspace** represented by the minus sign \-  
...
**Line 1: typed\_keys** A string representing all the pressed keys (characters/arrows/backspaces)
