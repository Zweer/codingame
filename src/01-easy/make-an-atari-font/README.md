...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/make-an-atari-font)

**Level:** easy
**Topics:** Radix, String manipulation, Ascii Art, 2D array, Bitboarding

## Goal 

There are Atari-style fonts, that replicate the very simple and stylized font used in classic Atari video games from the 1980s. For example, on https://opengameart.org/content/8x8-ascii-bitmap-font-with-c-source  
