# Set Probabilities (Card Game)

[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/set-probabilities-card-game)

**Level:** easy
**Topics:** Sets, Probability, Card games
