...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/defibrillators)

**Level:** easy
**Topics:** Loops, Distances, Trigonometry
...
_**Beware**: the decimal numbers use the comma (,) as decimal separator. Remember to turn the comma (,) into dot (.) if necessary in order to use the data in your program._  
