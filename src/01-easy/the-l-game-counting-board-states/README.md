...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/the-l-game-counting-board-states)
...
**Line 1 :** A single integer with N\_configs being the total number of legal configurations.
