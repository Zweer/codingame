...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/queen-control)

**Level:** easy
**Topics:** Conditions, Loops, Chess

## Goal 

Chess is played on an 8x8 board composed of 64 squares. In this game it is important to **control** a large amount of these squares to gain the upper hand on the opponent. A square is said to be controlled when it is in the range of movement of a chess piece.  
