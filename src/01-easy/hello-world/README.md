...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/hello-world)

**Level:** easy
**Topics:** Trigonometry, Geolocation, Great-circle distance, Sexagesimal system
...
Hints:  
For distance formula, see https://en.wikipedia.org/wiki/Great-circle\_distance  
...
**Next N lines:** Space separated name and geocoordinates (latitude and longitude) for the capitals. Note: name is not really used in the puzzle, but you still have to read them.  
