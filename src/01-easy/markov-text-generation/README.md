...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/markov-text-generation)

**Level:** easy
**Topics:** Hash tables, State machine, Probability
...
In the above example, the first lookup returns \['good','bad'\]. There are 2 options. Call pick\_option\_index(2) which will return 7%2 = 1\. Therefor we append 'bad' to our output sentence and continue from there calling pick\_option\_index for every lookup even if there is only 1 option.  
