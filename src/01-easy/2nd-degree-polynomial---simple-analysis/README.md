...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/2nd-degree-polynomial---simple-analysis)
...
**Line 1 :** a comma-separated list of P points (intersections with the X & Y axis), ordered from left to right, with each point formatted as **(x,y)** without spaces.  
