# anagram to break the code !

[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/anagram-to-break-the-code)

**Level:** easy
**Topics:** String manipulation, anagram

## Goal 

You are given a word and a string. To break the code, you must identify the key, which is the **first anagram of the word** in the string. Anagrams are considered case-insensitive, i.e. uppercase and lowercase letters are treated as the same. Then the code is a 4-digit code defined like that from left to right:  
...
\- We count only letters for the code.  
...
**Line 2:** a string s with an anagram
...
In s, we can find only English letters, spaces and the following punctuation marks: : . , ? !
