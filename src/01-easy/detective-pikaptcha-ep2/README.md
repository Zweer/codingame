...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/detective-pikaptcha-ep2)

**Level:** easy
**Topics:** Simulation, Maze
...
_Left wall following_

# Rules 

The maze is given to you as a grid filled with 0s and #s, where 0represents a passage, and # represents a wall: an impassable cell. 
