...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/escape-the-madness)

**Level:** easy
**Topics:** Parsing, Regular expressions
...
\* &entity\_name;: Produce the entity for which the name is entity\_name.  
