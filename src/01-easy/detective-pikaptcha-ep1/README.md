...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/detective-pikaptcha-ep1)

**Level:** easy
**Topics:** Maze, neighbour count

# The Goal 

**Detective Pikaptcha** is investigating a disturbance in the spacetime continuum. It seems a powerful _pokébot_ is being used to warp space around our hero to keep him trapped. Help him map his surroundings in order to escape and uncover the culprit! 
...
Next height lines: a string line of length widthwhere 0 is a passage and # is a wall. 
