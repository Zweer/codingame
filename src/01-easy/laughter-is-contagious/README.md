...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/laughter-is-contagious)

**Level:** easy
**Topics:** Conditions, Loops, Arrays, String manipulation
...
If a person starts laughing and is exactly at the same distance from two people laughing out loud, like 

Ef

 in the following example, he will take one letter from each of them ("closest letter" from each of them).  
