...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/xml-mdf-2016)
...
In this challenge, a data format that is a simplified version of XML is used. Tags are identified by a lowercase English letter. A start tag is represented by that single letter, and the closing tag is represented by the \- character, followed by that letter.  
