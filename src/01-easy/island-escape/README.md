...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/easy/island-escape)

**Level:** easy
**Topics:** Flood fill, 2D array

## Goal 

You're dropped onto an **island**, starting at the very **middle** of an N by N terrain. Luckily you have a **raft** and a **map** showing the elevation of each square plot of land. The **ocean** at elevation 0 surrounds the island and lies all along the borders of the map.  
