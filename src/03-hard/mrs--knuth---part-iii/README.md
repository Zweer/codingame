...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/mrs--knuth---part-iii)
...
This puzzle is part 3 of a multi-part Algorithm X tutorial and is meant to be done per the guidance in the following playground:  
