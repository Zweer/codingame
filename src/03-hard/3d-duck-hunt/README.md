...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/3d-duck-hunt)
...
The ducks’ velocity vectors are linearly independent in 3D space. (i.e.: the 3 vectors don't share a same plane, https://en.wikipedia.org/wiki/Linear\_independence)  
