...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/mind-cracker)

**Level:** hard
**Topics:** Optimization, Permutations, Combination puzzle
...
Check out the rules of Mastermind if needed: https://en.wikipedia.org/wiki/Mastermind\_(board\_game)#Gameplay\_and\_rules  
