...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/can-you-save-the-forest---episode-2)

**Level:** hard
**Topics:** Multi-agent, Simulation, Beam Search
...
_In this episode, we introduce the water square._Each of the 10 lines of the map is given to you by a string. Each character represents a cell of the map.  
