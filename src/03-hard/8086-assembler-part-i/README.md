...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/8086-assembler-part-i)

**Level:** hard
**Topics:** String manipulation, Interpreters
...
• Negative numbers are encoded using the two's complement representation https://en.wikipedia.org/wiki/Two%27s\_complement.  
...
The assembled code or the compilation error message.  
