...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/encounter-surface)
...
**Next n lines:** Two integers x\_1 and y\_1 representing the coordinates of each vertex of polygon 1.  
**Next m lines:** Two integers x\_2 and y\_2 representing the coordinates of each vertex of polygon 2.
