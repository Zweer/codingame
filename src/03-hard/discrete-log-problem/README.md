...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/discrete-log-problem)

**Level:** hard
**Topics:** Cryptography, Modular calculus
...
The rest of this protocol is not explained to avoid overload but it can be found on https://en.wikipedia.org/wiki/ElGamal\_encryption 
