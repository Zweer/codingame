...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/grid-climbing)

**Level:** hard
**Topics:** Dynamic programming, Memoization, Pathfinding, Recursion, Dijkstra
...
In costs, the n-1 integers satisfy: 0 < c\_1 < c\_2 < ... < c\_(n-1)  
3 <= n <= 40
