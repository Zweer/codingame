...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/dawg)
...
A graph for the example can be found here: https://en.wikipedia.org/wiki/Deterministic\_acyclic\_finite\_state\_automaton 
