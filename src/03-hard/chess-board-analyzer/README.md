...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/chess-board-analyzer)

**Level:** hard
**Topics:** Loops, Strings, 2D array, Chess
...
\- The given boards are legal and are assuming the official Chess rules: https://en.wikipedia.org/wiki/Rules\_of\_chess  
