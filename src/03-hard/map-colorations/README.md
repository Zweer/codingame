...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/map-colorations)
...
It is a well known result that a map, split into different regions (countries, states, ...) can be painted using different colors on contiguous regions with at most 4 different colors (see https://en.wikipedia.org/wiki/Four\_color\_theorem), although the proof isn't really obvious...  
