...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/a-game-of-go)
...
After executing all moves in the list the expected output is either NOT\_VALID if at least one of the moves is invalid, or the new state of the board after all moves were executed.  
...
https://en.wikipedia.org/wiki/Go\_(game)#Rules 
...
If at least one of the moves in the list is not valid just print: NOT\_VALID.  
