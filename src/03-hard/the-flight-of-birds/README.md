...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/the-flight-of-birds)

**Level:** hard
**Topics:** Simulation, Geometry, Collision Detection, Physics
...
Link:  
https://en.wikipedia.org/wiki/Reflection\_(physics)#Laws\_of\_reflection 
