...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/monte-carlo-tree-search-exercise)

**Level:** hard
**Topics:** Monte Carlo tree search, UCT, UCB1

## Goal 

Assume we are dealing with (nondeterministic) one-player game. To find an optimal sequence of movements we could use Monte Carlo Tree Search algorithm (https://en.wikipedia.org/wiki/Monte\_Carlo\_tree\_search).   
