...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/battleship-solitaire)

**Level:** hard
**Topics:** BFS, Recursion, Logic, Heuristic search, Algorithm X
...
The goal is to place all ships so that every constraint is met and the final configuration matches the provided clues.

![](https://cdn-games.codingame.com/community/3996809-1758310741063/6fb72a9c8ec6d4cdf117a9e527d81423fc3bc2a1354359eeebe6f0b6b6fbe33f.jpg) 
...
\- Press the gear icon on the viewer to access extra display options  
 \- This puzzle is based on a logical [game named Battleship Solitaire](https://lukerissacher.com/battleships) (Tips may be found here)  
 \- Source code on [my GitHub](https://github.com/VizGhar/CG-Battleships) 
