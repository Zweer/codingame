...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/divisibility-of-fibonacci-numbers-sum)

**Level:** hard
**Topics:** Loops, Recursion, Modular calculus, Arithmetic
...
**Determine if d divides F\_a \+ F\_{a+1} + F\_{a+2} + … + F\_b.**  
...
a \= 10  
b \= 12  
F\_10 + F\_11 + F\_12 = 55 + 89 + 144 = 288 = 32 \* 9 = 2^5 \* 3^2  
...
(When a \= b write in the same way the beginning "F\_a \+ ... + F\_b"  
...
https://en.wikipedia.org/wiki/Fibonacci\_number#Matrix\_form  
...
https://commons.wikimedia.org/wiki/File:Liber\_abbaci\_magliab\_f124r.jpg ) 
