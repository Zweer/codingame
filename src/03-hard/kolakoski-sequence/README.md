...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/kolakoski-sequence)
...
**Line 2:** Two space-separated digits A and B which will form the sequence, in that order
