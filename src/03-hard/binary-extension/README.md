...
[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/binary-extension)

**Level:** hard
**Topics:** Binary search, Steiner Tree
...
Next bombsCount lines: two integers x and ycorresponding to the coordinates of each bomb. 

Next goalsCount lines: two integers x and ycorresponding to the coordinates of each goal. 
