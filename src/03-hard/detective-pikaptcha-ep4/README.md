# Detective Pikaptcha EP4

[:link: Puzzle on CodinGame](https://www.codingame.com/training/hard/detective-pikaptcha-ep4)

**Level:** hard
**Topics:** Simulation, Maze, cube, 3D
...
![from-data-to-a-cube](https://www.codingame.com/servlet/mfileservlet?id=31428821177278)  

_Input data to a net of a cube_
...
Next 6\*N lines: a string line of length Nwhere 0 is a passage and # is a wall and \>, v, < or ^ is the initial position of Pikaptcha. 
