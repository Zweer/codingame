...
[:link: Puzzle on CodinGame](https://www.codingame.com/multiplayer/bot-programming/wondev-woman)

**Level:** multi
**Topics:** Programming Fundamentals, Flood fill, Minimax, Simulation, Maths / Physics
...
Line 2: an integer unitsPerPlayer for the number of units each player controls. _Always 1 for this league._
...
One line: MOVE&BUILD followed by index for the unit you wish to perform the action _(Always 0 for this league)_, dir1 for the direction in which the unit will move, dir2 for the direction of the cell the unit will raise the level of.  
