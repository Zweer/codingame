...
[:link: Puzzle on CodinGame](https://www.codingame.com/multiplayer/bot-programming/code-royale)

**Level:** multi
**Topics:** Programming Fundamentals, Algorithms, Resource management

![](//cdn.codingame.com/smash-the-code/statement/league_wood_04.png)

This is a league based puzzle

For this puzzle, multiple versions of the same game are available.  
Once you have proven your skills on this first version, you will access a higher league and extra rules will be unlocked.
...
The referee can be viewed [here](https://github.com/csj/team-2/blob/master/src/main/kotlin/com/codingame/game/Referee.kt).
...
* siteId: The numeric identifier of the site
* ignore1: _Reserved for future leagues._
* ignore2: _Reserved for future leagues._
* structureType:  
  * \-1: No structure
  * 2: Barracks
* owner:  
