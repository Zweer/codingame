...
[:link: Puzzle on CodinGame](https://www.codingame.com/multiplayer/bot-programming/amazons)

**Level:** multi
**Topics:** Monte Carlo tree search, Minimax, Bitboarding

This is a port of the board game [Amazons](https://en.wikipedia.org/wiki/Game%5Fof%5Fthe%5FAmazons).   
Click [here](https://github.com/MultiStruct/Amazons) for the referee.   
Boss made by [Astrobytes](https://www.codingame.com/profile/f76499818f5cfc3f3fa8c0eb31e13344919268).  
