...
[:link: Puzzle on CodinGame](https://www.codingame.com/multiplayer/bot-programming/ghost-in-the-cell)

**Level:** multi
**Topics:** Programming Fundamentals, Graphs, Algorithms, Resource management
...
![](https://www.codingame.com/servlet/fileservlet?id=10848419994968)

**Battles**  
  
To conquer a factory, you must send cyborgs to the coveted factory. Battles are played in this order:

1. Cyborgs that reach the same destination on the same turn fight between themselves.
2. Remaining cyborgs fight against the ones already present in the factory (beware that the cyborgs currently leaving do not fight).
...
![](https://www.codingame.com/servlet/fileservlet?id=10851217222317)
...
* You will be able to execute multiple actions during the same turn.
* You will be able to send bombs.
* You will be able to increase the production rate of your factories.
