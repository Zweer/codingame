...
[:link: Puzzle on CodinGame](https://www.codingame.com/multiplayer/bot-programming/a-code-of-ice-and-fire)
...
Starter AIs are available in the [Starter Kit](https://github.com/Azkellas/a-code-of-ice-and-fire/tree/develop/src/test/starterkit). They can help you get started with coding your own bot. Check out the [community events](https://github.com/Azkellas/a-code-of-ice-and-fire/blob/develop/COMMUNITY.MD) this week and have fun coding! 
...
![territory-ownership](https://www.codingame.com/servlet/fileservlet?id=28933360811968)  

_The red territory is composed of 6 cells. The 3 red-dark cells are now inactive because the blue player interrupted part of this territory. By capturing, for example, the cell marked by an X, the red player can make these cells active again._
...
![action-sequence-diagram](https://www.codingame.com/servlet/fileservlet?id=28956987525427) 
