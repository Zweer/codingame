...
[:link: Puzzle on CodinGame](https://www.codingame.com/multiplayer/bot-programming/winter-challenge-2026-snakebyte)

**Level:** multi
**Topics:** Pathfinding, Multi-agent
...
_Example:_ "0,1:1,1:2,1" _is a snakebot with a head at x=0 and y=1 with two more body parts to the right._
