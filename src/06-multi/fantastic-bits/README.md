...
[:link: Puzzle on CodinGame](https://www.codingame.com/multiplayer/bot-programming/fantastic-bits)

**Level:** multi
**Topics:** Programming Fundamentals, Algorithms, Multi-agent, Simulation, Distances, Trigonometry
...
**Edit: Since the challenge, new inputs/changes are available (magic, new states, spell duration/cost). If you want to reuse your challenge code, you will have to take them into account to avoid timeout errors.** 
...
It is impossible to leave the playing field. Wizards and Snaffles will rebound off the edges of the map.  
...
Extra details on the game mechanics will become available in league Wood 1.
...
First line: a string with 2 space separated integers for your score myScore and your magic points myMagic (not useful in this league).  
  
Next line: a string with 2 space separated integers for your opponent score opponentScore and your opponent magic points opponentMagic (not useful in this league).  
...
* OPPONENT\_WIZARD for an opposing wizard
* SNAFFLE
...
* A new entity: Bludgers.
* New commands: wizards may cast spells.
